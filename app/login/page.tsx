        ...
        <div className="w-full max-w-[900px] grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="rounded-2xl bg-[#111318] border border-[#1E2030] p-8 space-y-6 shadow-2xl shadow-black/40">
              ...
              <div className="text-center pt-1">
                <p className="text-sm text-[#9EA1B2]">
                  New to Fathom?{" "}
                  <Link href="/signup" className="text-[#00E5FF] hover:underline font-semibold">
                    Sign up
                  </Link>
                </p>
              </div>
          ...
          <div className="hidden md:flex flex-col justify-center">
            <div className="max-w-[420px] space-y-5 pl-4 lg:pl-8">
              ...
              <svg className="w-8 h-8 text-[#F97316] opacity-70" fill="currentColor" viewBox="0 0 24 24">
              ...
              <blockquote className="text-xl lg:text-2xl font-normal text-white leading-relaxed">
                &ldquo;Work smarter, not harder, they said.{" "}
                <span className="text-[#F97316] font-medium">Fathom took it personally.</span>&rdquo;
              </blockquote>

              <div className="flex items-center gap-3 pt-2">
                <div className="w-9 h-9 rounded-full bg-[#1A1512] border border-[#3A2418] flex items-center justify-center text-xs font-bold text-[#F97316]">
                  RK
                </div>
                <div>
                  <div className="text-sm font-semibold text-white">Rosanne K.</div>
                  <div className="text-xs text-[#727586]">Executive &amp; Founder</div>
                </div>
              </div>
            </div>
          </div>
